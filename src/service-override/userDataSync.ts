...
export default function getServiceOverride(): IEditorOverrideServices {
  return {
    ...
    [IUserDataSyncStoreManagementService.toString()]: new SyncDescriptor(
      UserDataSyncStoreManagementService,
      [],
      true
    ),
    [IUserDataSyncStoreService.toString()]: new SyncDescriptor(UserDataSyncStoreService, [], true),
    [IUserDataSyncEnablementService.toString()]: new SyncDescriptor(
    ...
    [IUserDataSyncAccountService.toString()]: new SyncDescriptor(
      UserDataSyncAccountService,
      [],
      true
    ),
    [IUserDataSyncMachinesService.toString()]: new SyncDescriptor(
      UserDataSyncMachinesService,
      [],
      true
    ),
    [IUserDataSyncResourceProviderService.toString()]: new SyncDescriptor(
      UserDataSyncResourceProviderService,
      [],
      true
    ),
    [IUserDataSyncLocalStoreService.toString()]: new SyncDescriptor(
      UserDataSyncLocalStoreService,
      [],
      true
    ),
    [IUserDataSyncWorkbenchService.toString()]: new SyncDescriptor(
